...
<body>
    ...
    <div class="detail-box">
        ...
        <form action="/informasi-mbkm/update/{{ $program->id }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-9">
                    ...
                    <textarea name="deskripsi" rows="6" class="form-control">{{ $program->deskripsi }}</textarea>
            ...
            <div class="row mb-3 align-items-center">
                ...
                <div class="col-md-9">
                    ...
                    <input type="text" name="link_daftar" class="form-control" value="{{ $program->link_daftar }}">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-9">
                    ...
                    <img src="{{ asset('images/' . $program->gambar) }}" width="300" class="img-thumbnail">
            ...
            <div class="text-center">
                ...
                <a href="/informasi-mbkm" class="btn btn-kembali">
