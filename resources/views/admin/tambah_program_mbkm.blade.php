...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="form-area">
            ...
            <form action="/informasi-mbkm/store" method="POST" enctype="multipart/form-data">
                ...
                <div class="text-center">
                    ...
                    <button type="submit" class="btn btn-simpan me-3">

                        Simpan

                    </button>

                    <a href="/informasi-mbkm" class="btn btn-batal">
